...
public class Components extends JComponent
{
    ...
    public void paintComponent(Graphics g)
    {
		...
		else
		{
			...
			g2.setColor(Color.blue);
			g2.drawString(yourScore,503,215);
			g2.drawString(clickToContinue,448,455);
			g2.drawString(yourHighScore,445,335);
			g2.setColor(Color.green);
			int xLoc = getWidth()/2-((int)getLength())/2;
			g2.drawString(""+score,xLoc,275);
			xLoc = getWidth()/2-((int)getHighLength())/2;
			g2.setColor(Color.red);
			g2.drawString(""+highScore,xLoc,395);
